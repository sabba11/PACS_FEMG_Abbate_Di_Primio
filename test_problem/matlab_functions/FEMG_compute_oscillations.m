...
% corresponding eigenvalues, as columns of a matrix.
%
% INPUT:
% eigvects		matrix whose columns are eigenvectors.
%
...
function FEMG_compute_oscillations(eigvects, mf, mesh)
